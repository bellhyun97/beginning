...
if __name__ == "__main__":
    global Machine_State, TrafficArray,pub_avoidance,pub_stop,pub_traffic,pub_parking,pub_safety#,pub_crosswalk,pub_speedbump
    ...
    pub_avoidance = rospy.Publisher('/adaptive_clustering/is_bool',Bool,queue_size=1) #/detect/obstacle => /adaptive_clustering/is_bool
