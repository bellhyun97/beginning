...
# Copyright (c) 2021, choiyungsik, jeonjonghyun
...
class CoreController():
    def __init__(self):
        ...
        self.Machine_State = Enum('Machine_State', 'cruise avoid_cruise stop traffic parking safety_zone backup',start=0) #crosswalk, speedbump
        ...
        self.StateGraph.layout.dim[0].size = 6 #8
    ...
    #     if event_msg.data == True:
    #         self.fnDecideMode(self.Machine_State.speedbump.value,0)
    
    def cbBackup(self,event_msg):
        self.step_num = event_msg.pose.position.z
        print('step num : ' ,self.step_num)

        if (19 <= self.step_num and self.step_num <= 30):
    ...
    def fnDecideMode(self,mode,sub_event):
        ...
        # elif mode == self.Machine_State.speedbump.value:
        ...
        #   self.cur_state = self.Machine_State.stop.value
            ...
            print("obstacle_timer : ", self.obstacle_timer, "obstacle_count", self.obstacle_count)
    ...
    def fnPublishMode(self):
        ...
        # elif self.StateGraph.data[self.Machine_State.speedbump.value] == 1:
        #     print('Speedbump_mode')
...
if __name__ == "__main__":
    ...
    #cruise -> default
    #stop_line -> s=1, d=0
    #self.dynamic_obstacle -> backup_state (195)
    #parking -> parking_end(control.py)
    #traffic_sign -> vision.py(darknet_ros)
    #adaptive_clustering -> path_obstacle.py